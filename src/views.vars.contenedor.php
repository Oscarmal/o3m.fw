...
// Carga la vista del Contenedor principal
	// print_r($inc);	die();
	global $cfg,$var, $Path, $dic, $contenedor, $usuario;
	## Logica de negocio ##
	if(!file_exists($Path[src].$inc)){				
		...
		$header_opc = array(
					...
					,LINK_SALIR		=> $Path['url'].$var[GENERAL].'/'.$var[LOGOUT]
